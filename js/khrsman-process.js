...
var page = window.location.href;
  ...
  $( document ).ajaxStart(function() {
       $(".content").append( '<div class="modal modal-info fade " id="loading_modal" role="dialog"><div class="modal-dialog" style="width:100px"><div class="modal-content"><div class="spinner"><div class="rect1"> </div> <div class="rect2"> </div> <div class="rect3"> </div> <div class="rect4"> </div><div class="rect5"></div> </div>        </div>       </div>     </div>     </div>');
    ...
    if(id){
      ...
      request.done(function(data){
        ...
        $.each(arr[0], function(key, value){
          var id_val = key;
          $("#"+id_val).val(value);
          $("#"+id_val).val(value).trigger('change'); //untuk select2
        });
        $('.add_page').hide();
        $('.edit_page').show();
